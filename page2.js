    ...
    window.addEventListener('load', randomizeInitialColors);
            ...
            const colors = ['rgb(254, 20, 22)', 'rgb(255, 123, 32)', 'rgb(255, 235, 17)', 'rgb(83, 221, 59)', 'rgb(37, 174, 228)', 'rgb(134, 72, 163)']; // Array of colors
            ...
            const predeterminedColors = {
                'one': 'rgb(134, 72, 163)', // Purple
                'two': 'rgb(37, 174, 228)', // Blue
                'three': 'rgb(83, 221, 59)',  // Green
                'four': 'rgb(255, 235, 17)', // Yellow
                'five': 'rgb(255, 123, 32)', // Orange
                'six': 'rgb(254, 20, 22)', // Red
            };
